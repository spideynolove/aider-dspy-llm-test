...
Nhiều người coi các agent thông minh là mục tiêu tối thượng của AI. Cuốn sách kinh điển của Stuart Russell và Peter Norvig, _Artificial Intelligence: A Modern Approach_ (Prentice Hall, 1995), định nghĩa lĩnh vực nghiên cứu AI là _“nghiên cứu và thiết kế các agent có lý trí.”_

Khả năng chưa từng có của các mô hình nền tảng đã mở ra cánh cửa cho các ứng dụng agent mà trước đây không thể tưởng tượng được. Những khả năng mới này cuối cùng đã giúp chúng ta có thể phát triển các agent thông minh tự động để đóng vai trò trợ lý, đồng nghiệp và huấn luyện viên của chúng ta. Chúng có thể giúp chúng ta tạo một trang web, thu thập dữ liệu, lên kế hoạch cho một chuyến đi, nghiên cứu thị trường, quản lý tài khoản khách hàng, tự động hóa nhập liệu, chuẩn bị cho các cuộc phỏng vấn, phỏng vấn ứng viên, đàm phán một thỏa thuận, v.v. Các khả năng dường như là vô tận, và giá trị kinh tế tiềm năng của các agent này là rất lớn.

Phần này sẽ bắt đầu với một cái nhìn tổng quan về các agent, sau đó tiếp tục với hai khía cạnh quyết định khả năng của một agent: công cụ và lập kế hoạch. Các agent, với các phương thức hoạt động mới, cũng có các phương thức thất bại mới. Phần này sẽ kết thúc với một cuộc thảo luận về cách đánh giá các agent để phát hiện ra những thất bại này.

_Bài viết này được điều chỉnh từ phần **Các Tác Nhân** trong [**AI Engineering**](https://amzn.to/49j1cGS) (2025) với một số chỉnh sửa nhỏ để biến nó thành một bài viết độc lập._

**Ghi chú**:

1.  Các agent được hỗ trợ bởi AI là một lĩnh vực mới nổi mà chưa có các khuôn khổ lý thuyết được thiết lập để định nghĩa, phát triển và đánh giá chúng. Phần này là một nỗ lực tốt nhất để xây dựng một khuôn khổ từ các tài liệu hiện có, nhưng nó sẽ phát triển cùng với lĩnh vực này. So với phần còn lại của cuốn sách, phần này mang tính thử nghiệm hơn. Tôi đã nhận được phản hồi hữu ích từ các nhà phê bình sớm, và tôi hy vọng sẽ nhận được phản hồi từ độc giả của bài viết này.
2.  Ngay trước khi cuốn sách này ra mắt, Anthropic đã xuất bản một bài viết trên blog về [Xây dựng các agent hiệu quả](https://www.anthropic.com/research/building-effective-agents) (Tháng 12 năm 2024). Tôi rất vui khi thấy rằng bài viết trên blog của Anthropic và phần về agent của tôi [có sự tương đồng về mặt khái niệm](https://cedricchee.com/blog/the-dna-of-ai-agents/), mặc dù với một số thuật ngữ hơi khác biệt. Tuy nhiên, bài viết của Anthropic tập trung vào các mẫu hình cô lập, trong khi bài viết của tôi đề cập đến lý do và cách thức mọi thứ hoạt động. Tôi cũng tập trung nhiều hơn vào việc lập kế hoạch, lựa chọn công cụ và các phương thức thất bại.
3.  Bài viết chứa nhiều thông tin nền tảng. Hãy thoải mái bỏ qua nếu bạn cảm thấy nó hơi quá chi tiết!
